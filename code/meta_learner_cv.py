...
class MetaLearner(object):
	...
	def train(self,fix_train_set_issue):
		...
		for epoch in range( self.num_updates ):
			...
			for i in range( self.meta_batch_size ):
				...
				observed_train_loader, observed_test_loader = get_observed_data_loader( self.meta_dataset.feature, self.meta_dataset.label, self.tissue_index_list, self.K, self.inner_batch_size, self.tissue_num, fix_train_set_issue)
